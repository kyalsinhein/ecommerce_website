...
<div class="header">
    ...
    <div class="container">
    <form action="signupcontroller.php" method="post" class="signupform">  
    <div class="signup">
        <center> <h1> Admin Sign Up Form </h1> </center></div>
    ...
    <a href="adminloginform.php" class="loginbtn">Go Back To Login Form</a>
     <br>
     <br>
    </div>
