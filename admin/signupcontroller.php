...
if($password !== $confirmpassword){
    ...
    location.href = 'adminsignupform.php';
    </Script>";
     
}
        // insert query 

        $insert_new_register = "INSERT INTO admin (username,email,address,phoneno,password) VALUES ('$username', '$email','$address','$phonenumber','$password')";
