...
<form action="customerlogincontroller.php" method="post" class="loginform">  
    <div class="login"><center> <h1> Login Form </h1> </center></div>
    <br>
    <br>  
          ...
          <br>
            ...
            <br> 
            <a href="customersignupform.php" class="createnewacc"> Create New Account? </a>
            </div>   
    </form>     
</div>
